...
|------------|-------|----------|------------|------|-----------|
| 7 (connected, bipartite, forest, regular, triangle_free, hamiltonian, eulerian) | 128 | 8 | 32 | 88 | 31.2% |

**Properties tracked:** connected, bipartite, forest, regular, triangle_free, hamiltonian, eulerian
