...
|------------|-------|----------|------------|------|-----------|
| 6 (connected, bipartite, forest, regular, triangle_free, hamiltonian) | 64 | 8 | 16 | 40 | 37.5% |

**Properties tracked:** connected, bipartite, forest, regular, triangle_free, hamiltonian
